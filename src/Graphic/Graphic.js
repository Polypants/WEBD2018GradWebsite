    ...
    return (
      <div className={ containerClasses }>
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 70 }px, ${ (this.props.mousePercent.y - 0.5) * 70 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 80 }px, ${ (this.props.mousePercent.y - 0.5) * 80 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 140 }px, ${ (this.props.mousePercent.y - 0.5) * 140 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 100 }px, ${ (this.props.mousePercent.y - 0.5) * 100 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 55 }px, ${ (this.props.mousePercent.y - 0.5) * 55 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 110 }px, ${ (this.props.mousePercent.y - 0.5) * 110 }px)`
          } : {}}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 35 }px, ${ (this.props.mousePercent.y - 0.5) * 35 }px)`,
            mixBlendMode: `overlay`
          } : { mixBlendMode: `overlay` }}
        >
        ...
        <div
          className="Graphic_shapeContainer" 
          style={ window.innerWidth >= 800 ? { 
            transform: `translate(${ (this.props.mousePercent.x - 0.5) * 40 }px, ${ (this.props.mousePercent.y - 0.5) * 40 }px)`,
            mixBlendMode: `overlay`
          } : { mixBlendMode: `overlay` }}
        >
